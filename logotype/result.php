...
<div class="wrapper">
<div class="tabs-divider"><span>Логотип PointBlank</span></div>

<div id="game">
 		  <div align=center>
														<?php
echo "<center><img src=userbar.php/?".$_SERVER['QUERY_STRING']."></center>";
?>
<br/><br/><br/>
<span style=""><a style="color:#282828; font-family: Tahoma;font-size:16px; " href="http://юзер-бар.рф/logotype/index.php">Назад</a></span>
		</div>
 	</div>
