...
<div id="game">
 ...
 <div style="width: 900px; margin: 0px auto">
            <div class="main_block">
                  Размер (<?php echo $apb_types[$type]['width']; ?> x <?php echo $apb_types[$type]['height']; ?>)
            </div>
                ...
                <table style="padding: 0px; margin: 0px; width: 100%; border-spacing: 0px">
                    <tr>
                        ...
                        <td style="width: 130px; text-align: right">
                              <input type="button" onclick="generateapb(<?php echo isset($_GET['type']) ? $_GET['type'] : 1; ?>);" name="generate" value="Сгенерировать" class="input_button"/>
                        </td>
                    </tr>
                </table>
            </div>
