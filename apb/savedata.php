...
$_SESSION['apb']['type'] = $type;

// ник
$_SESSION['apb']['nick_text'] = $nick_text;
$_SESSION['apb']['nick_text_color'] = $nick_text_color;
$_SESSION['apb']['nick_font_size'] = $nick_font_size;
$_SESSION['apb']['nick_font_type'] = $nick_font_type;
$_SESSION['apb']['nick_border_color'] = $nick_border_color;
$_SESSION['apb']['nick_border'] = $nick_border;

// клан
$_SESSION['apb']['clan_text'] = $clan_text;
$_SESSION['apb']['clan_text_color'] = $clan_text_color;
$_SESSION['apb']['clan_font_size'] = $clan_font_size;
$_SESSION['apb']['clan_font_type'] = $clan_font_type;
$_SESSION['apb']['clan_border_color'] = $clan_border_color;
$_SESSION['apb']['clan_border'] = $clan_border;

// ally
$_SESSION['apb']['ally_text'] = $ally_text;
$_SESSION['apb']['ally_text_color'] = $ally_text_color;
$_SESSION['apb']['ally_font_size'] = $ally_font_size;
$_SESSION['apb']['ally_font_type'] = $ally_font_type;
$_SESSION['apb']['ally_border_color'] = $ally_border_color;
$_SESSION['apb']['ally_border'] = $ally_border;

// hs
$_SESSION['apb']['hs_text'] = $hs_text;
$_SESSION['apb']['hs_text_color'] = $hs_text_color;
$_SESSION['apb']['hs_font_size'] = $hs_font_size;
$_SESSION['apb']['hs_font_type'] = $hs_font_type;
$_SESSION['apb']['hs_border_color'] = $hs_border_color;
$_SESSION['apb']['hs_border'] = $hs_border;

// weapon
$_SESSION['apb']['weapon_text'] = $weapon_text;
$_SESSION['apb']['weapon_text_color'] = $weapon_text_color;
$_SESSION['apb']['weapon_font_size'] = $weapon_font_size;
$_SESSION['apb']['weapon_font_type'] = $weapon_font_type;
$_SESSION['apb']['weapon_border_color'] = $weapon_border_color;
$_SESSION['apb']['weapon_border'] = $weapon_border;

// server
$_SESSION['apb']['server_text'] = $server_text;
$_SESSION['apb']['server_text_color'] = $server_text_color;
$_SESSION['apb']['server_font_size'] = $server_font_size;
$_SESSION['apb']['server_font_type'] = $server_font_type;
$_SESSION['apb']['server_border_color'] = $server_border_color;
$_SESSION['apb']['server_border'] = $server_border;

// lvl first
$_SESSION['apb']['lvl_text'] = $lvl_text;
$_SESSION['apb']['lvl_text_color'] = $lvl_text_color;
$_SESSION['apb']['lvl_font_size'] = $lvl_font_size;
$_SESSION['apb']['lvl_font_type'] = $lvl_font_type;
$_SESSION['apb']['lvl_border_color'] = $lvl_border_color;
$_SESSION['apb']['lvl_border'] = $lvl_border;

// lvl 1
$_SESSION['apb']['lvl1_text'] = $lvl1_text;
$_SESSION['apb']['lvl1_text_color'] = $lvl1_text_color;
$_SESSION['apb']['lvl1_font_size'] = $lvl1_font_size;
$_SESSION['apb']['lvl1_font_type'] = $lvl1_font_type;
$_SESSION['apb']['lvl1_border_color'] = $lvl1_border_color;
$_SESSION['apb']['lvl1_border'] = $lvl1_border;

// lvl 2
$_SESSION['apb']['lvl2_text'] = $lvl2_text;
$_SESSION['apb']['lvl2_text_color'] = $lvl2_text_color;
$_SESSION['apb']['lvl2_font_size'] = $lvl2_font_size;
$_SESSION['apb']['lvl2_font_type'] = $lvl2_font_type;
$_SESSION['apb']['lvl2_border_color'] = $lvl2_border_color;
$_SESSION['apb']['lvl2_border'] = $lvl2_border;

// lvl 3
$_SESSION['apb']['lvl3_text'] = $lvl3_text;
$_SESSION['apb']['lvl3_text_color'] = $lvl3_text_color;
$_SESSION['apb']['lvl3_font_size'] = $lvl3_font_size;
$_SESSION['apb']['lvl3_font_type'] = $lvl3_font_type;
$_SESSION['apb']['lvl3_border_color'] = $lvl3_border_color;
$_SESSION['apb']['lvl3_border'] = $lvl3_border;

// прочее
$_SESSION['apb']['background'] = $background;
$_SESSION['apb']['icon1'] = $icon1;
$_SESSION['apb']['icon2'] = $icon2;
$_SESSION['apb']['icon3'] = $icon3;
$_SESSION['apb']['icon4'] = $icon4;
$_SESSION['apb']['icon5'] = $icon5;
$_SESSION['apb']['icon6'] = $icon6;
$_SESSION['apb']['icon_choose'] = $icon_choose;
