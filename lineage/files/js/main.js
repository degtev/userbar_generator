...
function generatelineage(type) {
    var s = 'type=' + type + '&';
    
    var nick_form = $('#nick_form').serialize();
    var clan_form = $('#clan_form').serialize();
    var ally_form = $('#ally_form').serialize();
    var hs_form = $('#hs_form').serialize();
    var weapon_form = $('#weapon_form').serialize();
    var server_form = $('#server_form').serialize();
	var lvl_form = $('#lvl_form').serialize();
	var lvl1_form = $('#lvl3_form').serialize();
	var lvl2_form = $('#lvl2_form').serialize();
	var lvl3_form = $('#lvl1_form').serialize();
    ...
    switch(type) {
        case 1:
             s += nick_form + '&' + clan_form + '&' + ally_form + '&' + hs_form + '&' + lvl_form + '&' + lvl1_form + '&' + lvl2_form + '&' + lvl3_form + '&' +
            weapon_form + '&' + server_form + '&background=' + background + '&icon1=' + icon1 + '&icon2=' + icon2 + '&icon3=' + icon3 + '&icon4=' + icon4 + '&icon5=' + icon5 + '&icon6=' + icon6 + '&icon_choose=' + icon_choose;
            break;
            
        case 2:
            s += nick_form + '&' + clan_form + '&' + 
            weapon_form + '&' + server_form + '&background=' + background + '&icon1=' + icon1 + '&icon2=' + icon2 + '&icon_choose=' + icon_choose;
            break;
            
        case 3:
            s += nick_form + '&' + clan_form + '&background=' + background + '&icon1=' + icon1 + '&icon2=' + icon2 + '&icon_choose=' + icon_choose;
            break;
            
        case 4:
            s += nick_form + '&' + clan_form + '&' + ally_form + '&' + hs_form + '&' + '&background=' + background + '&icon1=' + icon1 + '&icon2=' + icon2 + '&icon_choose=' + icon_choose;
            
            break;
            
        case 5:
            s += nick_form + '&' + clan_form + '&' + ally_form + '&' + hs_form + '&' + 
            weapon_form + '&' + server_form + '&background=' + background + '&icon1=' + icon1 + '&icon2=' + icon2 + '&icon_choose=' + icon_choose;
        ...
        case 6:
            s += nick_form + '&' + clan_form + '&' + ally_form + '&' + hs_form + '&' + 
            '&background=' + background + '&icon1=' + icon1 + '&icon2=' + icon2 + '&icon_choose=' + icon_choose;
            
            break;
			
			        case 7:
             s += nick_form + '&' + clan_form + '&' + ally_form + '&' + hs_form + '&' + 
            weapon_form + '&' + server_form + '&background=' + background + '&icon1=' + icon1 + '&icon2=' + icon2 + '&icon3=' + icon3 + '&icon4=' + icon4 + '&icon5=' + icon5 + '&icon_choose=' + icon_choose;
