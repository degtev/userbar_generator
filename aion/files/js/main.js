...
function generateaion(type) {
	...
	var ally_form = $('#ally_form').serialize();
		var lvl1_form = $('#lvl1_form').serialize();
    ...
    switch(type) {
        case 1:
            s += nick_form + '&' + clan_form + '&' + kd_form + '&' + hs_form + '&' + ally_form + '&' + server_form + '&' +lvl1_form + '&' +
            weapon_form + '&background=' + background + '&icon1=' + icon1 + '&icon2=' + icon2 + '&icon3=' + icon3 + '&icon4=' + icon4 + '&icon5=' + icon5 + '&icon6=' + icon6 +'&icon_choose=' + icon_choose;
            break;
            
        case 2:
            s += nick_form + '&' + clan_form + '&' + 
            weapon_form + '&' + weapon2_form + '&background=' + background + '&icon1=' + icon1 + '&icon2=' + icon2 + '&icon_choose=' + icon_choose;
            break;
        ...
        case 4:
            s += nick_form + '&' + clan_form + '&' + kd_form + '&' + hs_form + '&' + '&background=' + background + '&icon1=' + icon1 + '&icon2=' + icon2 + '&icon_choose=' + icon_choose;
		...
		case 7:
             s += nick_form + '&' + clan_form + '&' + kd_form + '&' + hs_form + '&' + 
            weapon_form + '&' + weapon2_form + '&background=' + background + '&icon1=' + icon1 + '&icon2=' + icon2 + '&icon3=' + icon3 + '&icon4=' + icon4 + '&icon5=' + icon5 + '&icon_choose=' + icon_choose;
