...
$_SESSION['aion']['type'] = $type;

// ник
$_SESSION['aion']['nick_text'] = $nick_text;
$_SESSION['aion']['nick_text_color'] = $nick_text_color;
$_SESSION['aion']['nick_font_size'] = $nick_font_size;
$_SESSION['aion']['nick_font_type'] = $nick_font_type;
$_SESSION['aion']['nick_border_color'] = $nick_border_color;
$_SESSION['aion']['nick_border'] = $nick_border;

// клан
$_SESSION['aion']['clan_text'] = $clan_text;
$_SESSION['aion']['clan_text_color'] = $clan_text_color;
$_SESSION['aion']['clan_font_size'] = $clan_font_size;
$_SESSION['aion']['clan_font_type'] = $clan_font_type;
$_SESSION['aion']['clan_border_color'] = $clan_border_color;
$_SESSION['aion']['clan_border'] = $clan_border;

// ally
$_SESSION['aion']['ally_text'] = $ally_text;
$_SESSION['aion']['ally_text_color'] = $ally_text_color;
$_SESSION['aion']['ally_font_size'] = $ally_font_size;
$_SESSION['aion']['ally_font_type'] = $ally_font_type;
$_SESSION['aion']['ally_border_color'] = $ally_border_color;
$_SESSION['aion']['ally_border'] = $ally_border;

// hs
$_SESSION['aion']['hs_text'] = $hs_text;
$_SESSION['aion']['hs_text_color'] = $hs_text_color;
$_SESSION['aion']['hs_font_size'] = $hs_font_size;
$_SESSION['aion']['hs_font_type'] = $hs_font_type;
$_SESSION['aion']['hs_border_color'] = $hs_border_color;
$_SESSION['aion']['hs_border'] = $hs_border;

// weapon
$_SESSION['aion']['weapon_text'] = $weapon_text;
$_SESSION['aion']['weapon_text_color'] = $weapon_text_color;
$_SESSION['aion']['weapon_font_size'] = $weapon_font_size;
$_SESSION['aion']['weapon_font_type'] = $weapon_font_type;
$_SESSION['aion']['weapon_border_color'] = $weapon_border_color;
$_SESSION['aion']['weapon_border'] = $weapon_border;

// server
$_SESSION['aion']['server_text'] = $server_text;
$_SESSION['aion']['server_text_color'] = $server_text_color;
$_SESSION['aion']['server_font_size'] = $server_font_size;
$_SESSION['aion']['server_font_type'] = $server_font_type;
$_SESSION['aion']['server_border_color'] = $server_border_color;
$_SESSION['aion']['server_border'] = $server_border;

// lvl first
$_SESSION['aion']['lvl_text'] = $lvl_text;
$_SESSION['aion']['lvl_text_color'] = $lvl_text_color;
$_SESSION['aion']['lvl_font_size'] = $lvl_font_size;
$_SESSION['aion']['lvl_font_type'] = $lvl_font_type;
$_SESSION['aion']['lvl_border_color'] = $lvl_border_color;
$_SESSION['aion']['lvl_border'] = $lvl_border;

// lvl 1
$_SESSION['aion']['lvl1_text'] = $lvl1_text;
$_SESSION['aion']['lvl1_text_color'] = $lvl1_text_color;
$_SESSION['aion']['lvl1_font_size'] = $lvl1_font_size;
$_SESSION['aion']['lvl1_font_type'] = $lvl1_font_type;
$_SESSION['aion']['lvl1_border_color'] = $lvl1_border_color;
$_SESSION['aion']['lvl1_border'] = $lvl1_border;

// lvl 2
$_SESSION['aion']['lvl2_text'] = $lvl2_text;
$_SESSION['aion']['lvl2_text_color'] = $lvl2_text_color;
$_SESSION['aion']['lvl2_font_size'] = $lvl2_font_size;
$_SESSION['aion']['lvl2_font_type'] = $lvl2_font_type;
$_SESSION['aion']['lvl2_border_color'] = $lvl2_border_color;
$_SESSION['aion']['lvl2_border'] = $lvl2_border;

// lvl 3
$_SESSION['aion']['lvl3_text'] = $lvl3_text;
$_SESSION['aion']['lvl3_text_color'] = $lvl3_text_color;
$_SESSION['aion']['lvl3_font_size'] = $lvl3_font_size;
$_SESSION['aion']['lvl3_font_type'] = $lvl3_font_type;
$_SESSION['aion']['lvl3_border_color'] = $lvl3_border_color;
$_SESSION['aion']['lvl3_border'] = $lvl3_border;

// прочее
$_SESSION['aion']['background'] = $background;
$_SESSION['aion']['icon1'] = $icon1;
$_SESSION['aion']['icon2'] = $icon2;
$_SESSION['aion']['icon3'] = $icon3;
$_SESSION['aion']['icon4'] = $icon4;
$_SESSION['aion']['icon5'] = $icon5;
$_SESSION['aion']['icon6'] = $icon6;
$_SESSION['aion']['icon_choose'] = $icon_choose;
