                ...
                <fieldset class="rounded">
                    ...
                    <table style="margin: 0px; padding: 0px; border-spacing: 1px; width: 100%">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="hs_text" class="input_text"/>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 150px">
                            ...
                            <td>
                                <input type="text" name="hs_text_color" class="input_text colorpick" value="ffffff"/>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 150px">
                            ...
                            <td>
                                <select name="hs_font_size" class="input_select">
                                    <?php
                                    foreach ($font_sizes as $key => $value) {
                                        echo '<option value="' . $value . '">' . $value . '</option>';
                                    }
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="hs_font_type" class="input_select">
                                    <?php
                                    foreach ($font_types as $key => $value) {
                                        echo '<option value="' . $key . '">' . $value['name'] . '</option>';
                                    }
                        ...
                        <tr>
                            <td style="width: 150px" colspan="2">
                                Обводить: <label><input type="radio" name="hs_border" value="1" checked="checked" onchange="disableSwitcher(this, 'hs_border_color')" class="input_radio"/>Да</label> <label><input type="radio" name="hs_border" value="0" onchange="disableSwitcher(this, 'hs_border_color')" class="input_radio"/>Нет</label>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center" colspan="2">
                                Цвет обводки: <input type="text" name="hs_border_color" class="input_text colorpick" value="000000"/>
                            </td>
                        </tr>
                    </table>
                </fieldset>
                ...
                <fieldset class="rounded">
                    ...
                    <table style="margin: 0px; padding: 0px; border-spacing: 1px; width: 100%">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="weapon2_text" class="input_text"/>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 150px">
                            ...
                            <td>
                                <input type="text" name="weapon2_text_color" class="input_text colorpick" value="ffffff"/>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 150px">
                            ...
                            <td>
                                <select name="weapon2_font_size" class="input_select">
                                    <?php
                                    foreach ($font_sizes as $key => $value) {
                                        echo '<option value="' . $value . '">' . $value . '</option>';
                                    }
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="weapon2_font_type" class="input_select">
                                    <?php
                                    foreach ($font_types as $key => $value) {
                                        echo '<option value="' . $key . '">' . $value['name'] . '</option>';
                                    }
                        ...
                        <tr>
                            <td style="width: 150px" colspan="2">
                                Обводить: <label><input type="radio" name="weapon2_border" value="1" checked="checked" onchange="disableSwitcher(this, 'weapon2_border_color')" class="input_radio"/>Да</label> <label><input type="radio" name="weapon2_border" value="0" onchange="disableSwitcher(this, 'weapon2_border_color')" class="input_radio"/>Нет</label>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center" colspan="2">
                                Цвет обводки: <input type="text" name="weapon2_border_color" class="input_text colorpick" value="000000"/>
                            </td>
                        </tr>
                    </table>
                </fieldset>
