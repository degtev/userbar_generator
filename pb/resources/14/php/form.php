...
<td style="width: 33%; vertical-align: top">
		...
		<td style="width: 34%; vertical-align: top">
            <form id="weapon_form">
                <fieldset class="rounded">
                    <legend>Какое оружие юзаем ?</legend>
                    <table style="margin: 0px; padding: 0px; border-spacing: 1px; width: 100%">
                        <tr>
                            <td style="width: 150px">
                                Напиши тут:
    ...
    <tr>
        ...
        <td style="width: 33%; padding: 0px; vertical-align: top">
		 ...
		 <fieldset class="rounded">
                ...
                <select name="icon6" class="input_select" onchange="generatepb(<?php echo $type; ?>);">
                    <?php
		...
		<td style="width: 33%; padding: 0px; vertical-align: top">
            <fieldset class="rounded">
                <legend>Иконки скиллов</legend>
                <select name="icon3" class="input_select" onchange="generatepb(<?php echo $type; ?>);">
                    <?php
                ...
                <select name="icon4" class="input_select" onchange="generatepb(<?php echo $type; ?>);">
                    <?php
				...
				<select name="icon5" class="input_select" onchange="generatepb(<?php echo $type; ?>);">
                    <?php
